...
const Timeline = ({ year, desc }) => {
  return (
    <div className="flex gap-12 items-center">
      <div className="w-[10px] h-[10px] min-w-[10px] rounded-full bg-secondary outline-2 outline-secondary outline outline-offset-2"></div>
  ...
  return (
    <div className="p-xl bg-bg">
      <div className="container flex items-stretch justify-between gap-10">
        ...
        <div className="basis-1/2 relative z-[2] pt-5">
