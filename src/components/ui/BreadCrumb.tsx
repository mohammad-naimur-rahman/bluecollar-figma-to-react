...
const BreadCrumb = ({ title, img }: { title: string; img: string }) => {
  return (
    <section className="w-full h-[435px] lg:h-96 md:h-60 relative -z-10 overflow-hidden">
      ...
      <h1 className="absolute w-full left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 text-white text-center animate__animated animate__fadeIn">
        {title}
      </h1>
    </section>
  )
